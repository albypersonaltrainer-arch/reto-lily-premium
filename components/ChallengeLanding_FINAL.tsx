      ...
      <main>
            ...
            <div className="rounded-[2rem] border border-black/10 bg-[#fffaf2]/80 p-8 shadow-[0_30px_90px_rgba(35,24,14,0.16)]">
              ...
              <div className="mt-8 border-t border-black/10 pt-6">
                ...
                <p className="mt-4 text-lg leading-8 text-[#3e342a]">
                  No va de visualizar mejor, repetir afirmaciones o encontrar el siguiente bloqueo que sanar. Va de
                  descubrir qué personaje está creando tu experiencia y cómo empezar a elegir uno diferente.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="px-6 py-10 md:py-16">
          <div className="mx-auto max-w-5xl rounded-[2rem] border border-black/10 bg-[#fffaf2] p-8 shadow-[0_24px_70px_rgba(35,24,14,0.10)] md:p-12">
            {unlocked ? <SectionLabel>Acceso desbloqueado</SectionLabel> : null}
          ...
          <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[0.9fr_1.1fr]">
            <div className="rounded-[2rem] bg-[#111111] p-8 text-white md:p-10">
              ...
              <p className="mt-6 text-lg leading-8 text-white/75">
                ...
                siguen repitiendo los mismos resultados porque intentan cambiar su realidad sin cambiar
                el personaje desde el que la están viviendo.
              </p>
            </div>
            ...
            <div className="space-y-5">
              {[
                ...
                "Quieres una realidad diferente, pero sigues jugándola con el mismo personaje.",
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10 rounded-[2rem] bg-[#111111] p-8 text-white md:p-12">
              <p className="font-serif text-3xl leading-tight tracking-[-0.03em] md:text-5xl">
                Mientras sigas jugando con el mismo personaje, tu realidad podrá cambiar de forma,
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-3">
              {[
                {
                  day: "Día 1",
                  title: "El personaje determina la realidad que experimentas.",
                  text: "Descubrirás por qué sigues viviendo experiencias parecidas y cómo el personaje desde el que operas las mantiene.",
                },
                {
                  day: "Día 2",
                  title: "Tu personaje interpreta la realidad.",
                  text: "Descubrirás que no reaccionas a la realidad, sino a la interpretación que hace tu personaje de ella.",
                },
                {
                  day: "Día 3",
                  title: "No necesitas esforzarte más",
                  text: "Empezarás a elegir conscientemente el personaje desde el que quieres vivir una realidad diferente.",
                },
              ].map((item) => (
                <article
                  key={item.day}
