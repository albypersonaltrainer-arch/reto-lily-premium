...
function CheckIcon() {
  return (
    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#b78a3d] text-sm font-black text-white shadow-[0_10px_26px_rgba(183,138,61,0.28)]">
      ✓
    </span>
  );
}
  ...
  return (
    ...
    >
      ...
      <main className="relative z-10">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <div
              className={`rounded-[2rem] border p-8 transition duration-700 md:p-14 ${
                unlocked
                  ? "translate-y-0 border-[#b78a3d]/55 bg-[#fffaf1]/90 opacity-100 shadow-[0_28px_90px_rgba(82,55,24,0.18)]"
                  : "translate-y-3 border-[#b78a3d]/30 bg-[#fffaf1]/75 opacity-95 shadow-[0_22px_70px_rgba(82,55,24,0.12)]"
              }`}
            >
              {unlocked ? (
                <p className="mb-5 text-xs font-black uppercase tracking-[0.28em] text-[#6f3d2e]">
                  {accessUnlockedLabel}
                </p>
              ) : null}
          ...
          <div className="mx-auto max-w-content text-center">
            ...
            <div className="mx-auto mt-12 max-w-2xl rounded-[2rem] border border-[#b78a3d]/25 bg-[#fffaf1]/85 p-8 shadow-[0_28px_90px_rgba(82,55,24,0.14)] backdrop-blur md:p-12">
              ...
              <div className="mx-auto mt-8 grid max-w-xl gap-4 text-left">
                {fixedAccessItems.map((item) => (
                  <div
                    key={item}
                    className="flex items-start gap-3 rounded-2xl border border-[#b78a3d]/20 bg-white/50 p-4 text-base font-semibold leading-7 text-[#4a3524]"
                  >
                    <CheckIcon />
                    <span>{item}</span>
                  </div>
        ...
        <section className="px-6 py-20 md:py-28">
          <div className="mx-auto grid max-w-content items-center gap-12 rounded-[2rem] border border-[#b78a3d]/20 bg-[#fffaf1]/72 p-8 shadow-[0_28px_90px_rgba(82,55,24,0.13)] backdrop-blur md:grid-cols-[0.85fr_1.15fr] md:p-12">
            <div>
        ...
        >
          <div className="mx-auto max-w-4xl rounded-[2rem] border border-[#b78a3d]/20 bg-[#fffaf1]/72 p-4 shadow-[0_28px_90px_rgba(82,55,24,0.13)] backdrop-blur md:p-6">
            <LeadForm copy={copy} />
          </div>
        </section>
